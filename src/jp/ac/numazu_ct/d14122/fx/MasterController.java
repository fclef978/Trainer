...
import jp.ac.numazu_ct.d14122.main.TableTest;
import jp.ac.numazu_ct.d14122.math.FunctionGenerator;
import jp.ac.numazu_ct.d14122.math.VirtualADC;
...
public class MasterController {
    ...
    public void setSetEvent(Pane parent, jp.ac.numazu_ct.d14122.gl.pane.Pane masterPane, Consumer<Integer> action) {
    ...
    public class Channel {
        ...
        public int getChNum() {
            return Integer.decode(channel.getText());
        }
